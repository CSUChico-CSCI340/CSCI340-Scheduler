...
Looking at the {\tt schedule.cc} file, you will see that it contains rudimentary scheduler API to add a process, remove a process, and get the next process from your scheduler. Your job is to implement a the code in schedule.cc that implements a First Come First Serve (FCFS) Scheduler. 
